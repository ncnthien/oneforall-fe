...
const accessoryFilter = [accessoryTypeDropDown, brandDropDown, priceDropDown]
  ...
  reducers: {
    loadFilter: (
      ...
      switch (action.payload) {
        case 'laptop':
          state.filter = laptopFilter
          break
        case 'pc':
          state.filter = pcFilter
          break
        case 'accessory':
          state.filter = accessoryFilter
          break
        default:
          break
      }
...
export const { loadFilter } = filterSlice.actions
